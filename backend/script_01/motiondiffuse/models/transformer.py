...
class MotionTransformer(nn.Module):
    ...
    def forward(self, x, timesteps, length=None, text=None, xf_proj=None, xf_out=None, return_hidden=False):
        """
        x: B, T, D
        """
        ...
        #this is a diffusion model so runs multiple forward passes to denoise
        if return_hidden:
            return {
                "output": output,
                "motion_latent": h,
                "hidden_states": hidden_states,
                "text_token_latent": xf_out,
                "text_global_latent": xf_proj,
                "src_mask": src_mask,
            }
        return output
