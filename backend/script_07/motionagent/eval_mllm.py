...
def eval_t2m():
    ...
    test_loader = dataset_TM_eval.DATALoader(args.dataname, "test", 32, w_vectorizer, unit_length=2**args.down_t) # batch size should be fixed to 32 thus need humanml3d
