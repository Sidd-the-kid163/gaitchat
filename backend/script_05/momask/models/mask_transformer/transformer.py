...
class MaskTransformer(nn.Module):
    ...
    def trans_forward(self, motion_ids, cond, padding_mask, force_mask=False, hidden_state=False):
        '''
...
class ResidualTransformer(nn.Module):
    ...
    def trans_forward(self, motion_codes, qids, cond, padding_mask, force_mask=False, hidden_state=False):
        '''
